// include folder for tensorRT: 
// include folder for other folder src: /content/DeepLearningDeployment/tensorrt/cpp_deploy/src
// include folder for Opencv 

// lib for trt
// lib for Opencv

// g++ -shared -std=c++11 -Wall -fPIC -o libtrtpy.so /content/DeepLearningDeployment/tensorrt/cpp_deploy/src/inference.cpp extern_for_python.cpp -I ??? -I /content/DeepLearningDeployment/tensorrt/cpp_deploy/src -L??? -lonnxruntime -Wl,-R,/home/luhsuanwen/onnxruntime/build/Linux/RelWithDebInfo/ -I /usr/local/include/opencv4/ -L/usr/local/lib -lopencv_calib3d -lopencv_core -lopencv_dnn -lopencv_features2d -lopencv_flann -lopencv_gapi -lopencv_highgui -lopencv_imgcodecs -lopencv_imgproc -Wl,-R,/usr/local/lib
...
#include "inference.h"
extern "C" float* trt_inference(char* modelPath, char* imagePath){
